...
//        }
        ...
        @Override
        public void onFramePreview(Image.Plane[] planes, int width, int height, int orientation) {
            for (Callback callback : mCallbacks) {
                callback.onFramePreview(CameraView.this, planes, width, height, orientation);
            }
        }
    ...
    public abstract static class Callback {
        ...
        public void onFramePreview(CameraView cameraView, Image.Plane[] planes, int width, int height, int orientation) {
        }
